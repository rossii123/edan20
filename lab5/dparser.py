...
if __name__ == '__main__':
    ...
    X_test_U, y_test_U = calculateSomething(test_file)
    ...
    #print(str(le.classes_) + "."+ str(len(le.classes_)))
    ...
    y_U = le.fit_transform(y_unEncoded)
    X_U = v.fit_transform(X_unEncoded)
    y_pred_U = model.predict(X_U)
    aS = accuracy_score(y_U,y_pred_U)
    print("Accuracy on test data:" + str(aS))
